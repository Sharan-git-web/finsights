  ...
  const renderCards = () => {
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 transition-all animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-[var(--bg-card)] p-7 rounded-2xl border border-[var(--border-color)] shadow-sm hover:shadow-md transition-all">
  ...
  const renderCharts = () => {
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
        <div className="lg:col-span-2 bg-[var(--bg-card)] p-8 rounded-2xl border border-[var(--border-color)] shadow-sm">
