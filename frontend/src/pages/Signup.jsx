    ...
    if (isSuccess) {
        return (
            <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 md:p-6 relative overflow-hidden">
                ...
                <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-2xl border border-slate-800/50 rounded-3xl md:rounded-[32px] p-8 md:p-10 text-center space-y-6 shadow-2xl relative z-10">
                    ...
                    <Link
                        to="/login"
                        className="block w-full bg-slate-900/50 border-2 border-slate-800 text-white py-4 rounded-xl md:rounded-2xl font-black hover:bg-slate-800 transition-all touch-target"
                    >
                        Back to Login
                    </Link>
                </div>
            ...
            <div className="w-full max-w-md space-y-6 md:space-y-8 relative z-10">
                <div className="text-center space-y-4 md:space-y-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm md:text-base text-slate-400 font-medium">Get started with FINSIGHTS</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-4 md:space-y-5">
                            ...
                            <div className="px-1">
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    ...
                                    />
                                    <span className="text-xs md:text-sm font-semibold text-slate-400 group-hover:text-slate-300 transition-colors leading-tight">
                                        I agree to the <Link to="/terms" className="text-purple-500 hover:underline">Terms</Link> and <Link to="/privacy" className="text-purple-500 hover:underline">Privacy</Link>
                                    </span>
                                </label>
                            </div>
                        </div>
